...
const SvgIcons = () => {
  ...
  delicious:function({fill, size}:{fill?:string, size?:string}){
    return (
<SvgIcon path={paths.delicious.svgPath} fill={fill} size={size} />
  )} ,
...
<SvgIcon path={paths.deviantArt.svgPath} fill={fill} size={size} />
  ...
  dribble: function({fill, size}:{fill?:string, size?:string}){
    return (
<SvgIcon path={paths.dribble.svgPath} fill={fill} size={size} />
  )} ,

  email: function({fill, size}:{fill?:string, size?:string}){
    return (
<SvgIcon path={paths.email.svgPath} fill={fill} size={size} />
  )} ,

  etsy: function({fill, size}:{fill?:string, size?:string}){
    return (
<SvgIcon path={paths.etsy.svgPath} fill={fill} size={size} />
  )} ,

  facebook: function({fill, size}:{fill?:string, size?:string}){
    return (
<SvgIcon path={paths.facebook.svgPath} fill={fill} size={size} />
  )} ,

  forrst: function({fill, size}:{fill?:string, size?:string}){
    return (
<SvgIcon path={paths.forrst.svgPath} fill={fill} size={size} />
  )} ,

  gitHub: function({fill, size}:{fill?:string, size?:string}){
    return (
<SvgIcon path={paths.track.svgPath} fill={fill} size={size} />
  )} ,
