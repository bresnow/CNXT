            ...
            <div className='dropdown my-1 cursor-pointer'>
              ...
              >
                <ul className='scrollbar-custom flex max-h-48 flex-col overflow-y-auto'>
                  <li>
                    <div className='dropdown-item font-display dark:flex justify-between rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white'>
                  ...
                  <li>
                    <div className='dropdown-item font-display dark:flex rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white'>
                      <span className='flex items-center space-x-3'>
                        <img
